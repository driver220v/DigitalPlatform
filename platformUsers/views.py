...
class SignUpView(View):
    ...
    def get(self, request):
        return render(request, 'platformUsers/index.html',
                      context={'profile': self.profile_form,
                               'user': self.user_form()})
...
class SingInView(View):
    ...
    def get(self, request):
        if not request.user.is_authenticated:
            return render(request, 'platformUsers/index.html', context={'user': self.auth_form()})
        return HttpResponseRedirect(reverse('HomeView'))
